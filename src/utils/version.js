...
const address = [
  [
    `https://raw.githubusercontent.com/lover520f/my-music/master/publish/version.json`,
    'direct',
  ],
]
...
export const downloadNewVersion = async (version, onDownload = noop) => {
  ...
  const url = `https://github.com/lover520f/my-music/releases/download/v${version}/my-music-v${version}-${abi}.apk`
  let savePath = temporaryDirectoryPath + '/my-music.apk'
