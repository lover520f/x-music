package com.my.music.moblie.widget;
...
public class MusicWidgetProvider extends AppWidgetProvider {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.my.music.moblie.widget.PLAY_PAUSE";
    public static final String ACTION_PREV = "com.my.music.moblie.widget.PREV";
    public static final String ACTION_NEXT = "com.my.music.moblie.widget.NEXT";
    public static final String ACTION_UPDATE_WIDGET = "com.my.music.moblie.widget.UPDATE";

    // Internal actions to forward to JS to avoid loop
    public static final String INTERNAL_ACTION_PLAY_PAUSE = "com.my.music.moblie.widget.INTERNAL_PLAY_PAUSE";
    public static final String INTERNAL_ACTION_PREV = "com.my.music.moblie.widget.INTERNAL_PREV";
    public static final String INTERNAL_ACTION_NEXT = "com.my.music.moblie.widget.INTERNAL_NEXT";
